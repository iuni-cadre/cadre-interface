export default {
    ...
    input: {
        ...
        inventor_location_city: {label: "Inventor City", operators: ["OR", "AND"]},
        inventor_location_country: {label: "Inventor Country", operators: ["OR", "AND"]},
        inventor_location_state_fips: {label: "Inventor State FIPS", operators: ["OR", "AND"]},
        inventor_location_county_fips: {label: "Inventor County FIPS", operators: ["OR", "AND"]},
        
        assignee_location_city: {label: "Assignee City", operators: ["OR", "AND"]},
        assignee_location_country: {label: "Assignee Country", operators: ["OR", "AND"]},
        assignee_location_state_fips: {label: "Assignee State FIPS", operators: ["OR", "AND"]},
        assignee_location_county_fips: {label: "Assignee County FIPS", operators: ["OR", "AND"]},
        assignee_organization: {label: "Assignee Organization", operators: ["OR", "AND"]},
